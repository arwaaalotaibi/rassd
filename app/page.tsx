          ...
          <div className="export-dialog controls tour-dialog" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="tour-list">
              ...
              <div className="tour-item">
                <span className="tour-emoji">📄</span>
                <span>
                  <b>زر التصدير</b> (بجانب البحث) يحفظ صفحات المصحف ملف <b>PDF</b>{' '}
                  بألوان الرصد كما تراها على الشاشة: حدّد من صفحة إلى صفحة (حتى ٥٠
                  صفحة)، وستُضمَّن أخطاء الجلسات الظاهرة فقط — أخفِ أي جلسة من
                  «جلسات التسميع» قبل التصدير إن أردت. الملف ينزل مباشرة، جاهزاً
                  للطباعة أو إرساله للطالب ووليّ أمره.
                </span>
              </div>
              <div className="tour-item">
                <span className="tour-emoji">📅</span>
