          ...
          <div className="export-dialog controls tour-dialog" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="tour-list">
              ...
              <div className="tour-item">
                <span className="tour-emoji">📖</span>
                <span>
                  <b>الشارة العلوية</b> للتنقل: اختر سورة أو اكتب رقم صفحة واضغط
                  «اذهب».
                </span>
              </div>
              <div className="tour-item">
                <span className="tour-emoji">🔍</span>
                <span>
                  <b>البحث في الآيات:</b> اكتب كلمة أو جزء آية <b>بلا حركات</b>{' '}
                  فتظهر كل الآيات التي وردت فيها مع اسم السورة ورقم الآية
                  والصفحة — ونقرة على أي نتيجة تنقلك إلى صفحتها وتومض الآية
                  لتلمحها فوراً.
                </span>
              </div>
              <div className="tour-item">
                <span className="tour-emoji">📄</span>
                <span>
                  <b>زر التصدير</b> يحفظ صفحات المصحف ملف <b>PDF</b> بألوان الرصد
                  كما تراها على الشاشة: حدّد من صفحة إلى صفحة (حتى ٥٠ صفحة)،
                  وستُضمَّن أخطاء الجلسات الظاهرة فقط — أخفِ أي جلسة من «جلسات
                  التسميع» قبل التصدير إن أردت. الملف ينزل مباشرة، جاهزاً للطباعة
                  أو إرساله للطالب ووليّ أمره.
                </span>
              </div>
              <div className="tour-item">
                <span className="tour-emoji">📅</span>
